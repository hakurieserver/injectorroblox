local Fluent = loadstring(game:HttpGet("https://github.com/hakurieserver/injectorroblox/releases/download/a/main.lua"))()
local SaveManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/hakurieserver/injectorroblox/main/SaveManager.lua"))()
local InterfaceManager = loadstring(game:HttpGet("https://raw.githubusercontent.com/hakurieserver/injectorroblox/main/InterfaceManager.lua"))()
----------------------------------------------------------------------------------------------------------------------------------------------
local Window = Fluent:CreateWindow({
    Title = "HakurieScript | Blox Fruits Script",
    SubTitle = "HakurieScript make by Đài Phát Thanh Gensokyou (https://soundcloud.com/remiliav2)",
    TabWidth = 160,
...
local Tabs = {
    ...
    Race = Window:AddTab({ Title = "Nâng V4", Icon = "chevrons-right" }),
...
Tabs.Main:AddButton({
    ...
    Tabs.Main:AddButton({
        Title = "Fps Booster",
        Description = "Giảm Lag (Có thể bị đơ và giật bay máy)",
        Callback = function()
            FPSBooster()
        end
    })
...
game:GetService("RunService").RenderStepped:Connect(function()
    ...
    spawn(function()
     ...
     local ToggleShark = Tabs.Main:AddToggle("ToggleShark", {Title = " Kill Shark",Description = "Đánh Gura", Default = false })
    ...
    local ToggleFishCrew = Tabs.Main:AddToggle("ToggleFishCrew", {Title = " Kill Fish Crew",Description = "Đánh Cá Crew", Default = false })
...
local SliderDelayAttackPlayer = Tabs.Player:AddSlider("SliderDelayAttackPlayer", {
    ...
    Description = "Tốc độ Đánh (tính = giây và càng thấp càng tốt)",
    Default = 0.1,
    Min = 0,
    Max = 5,
    Rounding = 1,
...
local ToggleCollectTP = Tabs.Fruit:AddToggle("ToggleCollectTP", {Title = "Collect Devil Fruit (TP)",Description = "Nhặt Trái (TP)", Default = false })
...
local ToggleCollect = Tabs.Fruit:AddToggle("ToggleCollect", {Title = "Collect Devil Fruit (Tween)",Description = "Nhặt Trái (Tween)", Default = false })
...
local ToggleAwake = Tabs.Raid:AddToggle("ToggleAwake", {Title = "Auto Awake",Description = "Thức tỉnh V2 (Tự động)", Default = false })
...
local ToggleLaw = Tabs.Raid:AddToggle("ToggleLaw", {Title = "Auto Law",Description = "Auto mua chip + Đánh boss law", Default = false })
...
local ToggleAutoAcientQuest = Tabs.Race:AddToggle("ToggleAutoAcientQuest", {Title = "Auto Train",Description = "cày + bật tộc (Tự động)", Default = false })
...
Tabs.Misc:AddButton({
	Title = "Rejoin Server",
	Description = "tham gia lại máy chủ (Có nguy cơ phải re-injector)",
	Callback = function()
...
Tabs.Misc:AddButton({
	Title = "Hop Server",
	Description = "Đổi máy chủ (Có nguy cơ phải re-injector)",
	Callback = function()
		Hop()
	end
})
			...
			for k, v in pairs(v) do
				if Items[v.ItemName.Text] and Items[v.ItemName.Text].Mastery then
					if v.ItemLine2.Text ~= "Accessory" then
						local nad                  = v.ItemName:Clone()
						nad.BackgroundTransparency = 1
						nad.TextSize               = 10
						nad.TextXAlignment         = 2
						nad.TextYAlignment         = 2
						nad.ZIndex                 = 5
						nad.Text                   = Items[v.ItemName.Text].Mastery
						nad.Size                   = UDim2.new(.5, 0, .5, 0)
						nad.Position               = UDim2.new(.5, 0, .5, 0)
						nad.Parent                 = v
					end
					v.Parent = cac
...
if First_Sea or Second_Sea then
    local Mastery = Tabs.Hop:AddSection("Chỉ áp dụng ở Thid Sea !!!")
end
...
Fluent:Notify({
    Title = "HakurieScript",
    Content = "Đoạn mã đag tải, đợi một chút....",
    Durtion = 3
})
warn("Đoạn mã đã tải xong !!")
warn("Chúc vui vẻ!")